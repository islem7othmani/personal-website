...
<ol class="relative border-l border-gray-200 dark:border-gray-700 ml-56 mt-20" data-aos="fade-up" >                  
    <li class="mb-10 ml-6" >            
        ...
        <h3 class="flex items-center mb-1 text-lg font-semibold text-white dark:text-white">Flowbite Application UI v2.0.0 <span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ml-3">Latest</span></h3>
    ...
    <li class="mb-10 ml-6">
        ...
        <h3 class="mb-1 text-lg font-semibold text-white dark:text-white">Flowbite Figma v1.3.0</h3>
    ...
    <li class="ml-6">
        ...
        <h3 class="mb-1 text-lg font-semibold text-white dark:text-white">Flowbite Library v1.2.2</h3>
